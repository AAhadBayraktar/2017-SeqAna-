...
## For infp about parallelis m in GATK :
...
LANE4_R2=$SAMPLE_PREFIX\_L004_R2_001.fastq
...
# Step extra - Filter annotation file
# Parameters set by Sinan Fındık
sed -n 1p $SAMPLE_DIR/recalibrated_variants.annotation.hg19_multianno.txt > $SAMPLE_DIR/filtered_variants.txt && \
awk '{FS="\t";if($9=="frameshift indel"||$9=="stoploss"||$9=="stopgain"||$9=="nonsynonymous SNV")if($18<0.002)\
if($29=="D")if($35=="D"||$35=="P")if($50=="D")if($93!=".")print $_}' \
$SAMPLE_DIR/recalibrated_variants.annotation.hg19_multianno.txt >> $SAMPLE_DIR/filtered_variants.txt
